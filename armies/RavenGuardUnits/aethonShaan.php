...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='1'";
...
<!--Unit name and title-->	
<p id="Unit">Aethon Shaan</p>
<p id="title">Chapter Master of the Raven Guard</p>

<!--Product select form-->
<div class="product">
    <img src="../../finalProjectUnits/AethonShaan.jpg" alt="Aethon Shaan">
