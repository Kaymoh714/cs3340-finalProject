...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='2'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Kayvaan Shrike unit">
...
<!--Unit name and title-->
<p id="Unit">Kayvaan Shrike</p>
<p id="title">Raven Guards' Master of Stealth and Ambush</p>

<!--product select form-->
<div class="product">
    <img src="../../finalProjectUnits/KayvaanShrike.jpg" alt="KayvaanShrike">
