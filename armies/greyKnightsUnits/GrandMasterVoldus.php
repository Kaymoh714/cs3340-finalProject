...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='13'";
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>Grand Master Voldus</title>
		<meta name="author" content="Kareem Mohammed">
		<meta name="student number" content ="104778164">
		<meta name="description" content = "Grand Master Voldus unit">
...
<!--Unit name and title-->	
<p id="Unit">Grand Master Voldus</p>
<p id="title">Warden of the Librarius</p>

<!--Product select form-->
<div class="product">
    <img src="../../finalProjectUnits/Voldus.jpg" alt="Grand Master Voldus
