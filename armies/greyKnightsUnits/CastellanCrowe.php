...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='12'";
...
<!--Unit name and title-->
<p id="Unit">Castellan Crowe</p>
<p id="title">Warden of the Blade</p>

<!--Product Select form-->
<div class="product">
    <img src="../../finalProjectUnits/Castellan.jpg" alt="Castellan Crowe">
