...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='20'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Ezekiel unit">
...
<!--Unit name and title-->	
<p id="Unit">Ezekiel</p>
<p id="title">Keeper of the Book of Salvation</p>

	<!--Product Select form-->
<div class="product">
    <img src="../../finalProjectUnits/Ezekiel.jpg" alt="Ezekiel">
