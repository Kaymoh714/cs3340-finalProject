...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='19'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Sammael unit">
...
<!--Unit name and title-->	
<p id="Unit">Sammael</p>
<p id="title">Leader of the Hunt</p>

<!--Product select form-->	
<div class="product">
    <img src="../../finalProjectUnits/Sammael.jpg" alt="Sammael">
