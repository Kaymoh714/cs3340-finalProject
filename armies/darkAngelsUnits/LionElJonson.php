...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='16'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Lion El'Jonson unit">
...
<!--Unit name and title-->
<p id="Unit">Lion El'Jonson</p>
<p id="title">Primarch of the Dark Angels</p>

<!--Product Select form-->	
<div class="product">
    <img src="../../finalProjectUnits/Lion.jpg" alt="Lion El'Jonson">
