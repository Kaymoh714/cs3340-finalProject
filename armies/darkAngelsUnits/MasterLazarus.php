...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='18'";
...
<html lang="en">
	<head>
		...
		<meta charset="utf-8">
		<title>Master Lazarus</title>
		<meta name="author" content="Kareem Mohammed">
		<meta name="student number" content ="104778164">
		<meta name="description" content = "Master Lazarusunit">
		<meta name="assignment" content="Final Project">	

		<link rel="stylesheet" href="/finalProject/finalProjectStyle.css">
	</head>
...
<!--Unit name and title-->	
<p id="Unit">Master Lazarus</p>
<p id="title">Keeper of the Unseen Ritual</p>

	<!--Product select form-->
<div class="product">
    <img src="../../finalProjectUnits/Lazarus.jpg" alt="Master Lazarus">
