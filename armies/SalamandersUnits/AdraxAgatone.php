...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='5'";
...
<!--Unit name and title-->
<p id="Unit">Adrax Agatone</p>
<p id="title">Arsenal Master of the Salamanders</p>

<!--product select form-->
<div class="product">
    <img src="../../finalProjectUnits/Adrax.jpg" alt="Adrax Agatone">
