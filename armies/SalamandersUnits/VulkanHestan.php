...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='6'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Vulkan He'stan unit">
...
<!--Unit name and title-->	
<p id="Unit">Vulkan He'stan</p>
<p id="title">Forgefather of the Salamanders</p>

<!--Product select form-->	
<div class="product">
    <img src="../../finalProjectUnits/vulkan.jpg" alt="Vulkan He'stan">
