...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='8'";
...
<!--Unit name and title-->	
<p id="Unit">Ragnar Blackmane</p>
<p id="title">The Black Wolf of the Space Wolves</p>

<!--Form to choose which paint option to select-->
<div class="product">
    <img src="../../finalProjectUnits/Ragnar.jpg" alt="Ragnar Blackmane">
