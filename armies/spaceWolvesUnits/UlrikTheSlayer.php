...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='7'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Ulrik The Slayer unit">
...
<!--Unit name and title-->	
<p id="Unit">Ulrik The Slayer</p>
<p id="title">High Wolf Priest of the Space Wolves</p>


	<!--Product selection form-->
<div class="product">
    <img src="../../finalProjectUnits/Ulrik.jpg" alt="Ulrik The Slayer">
