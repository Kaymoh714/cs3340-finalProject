...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='4'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Kor'Sarro Khan unit">
...
<!--Unit Name and Title-->	
<p id="Unit">Kor'sarro Khan</p>
<p id="title">Master of the Hunt</p>

<!--Div showcasing the unit, image and product options, with option to add to cart-->	
<div class="product">
    <img src="../../finalProjectUnits/Korsarro.jpg" alt="Kor'sarro Khan">
