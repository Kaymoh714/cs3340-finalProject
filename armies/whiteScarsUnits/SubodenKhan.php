...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='3'";
...
<p id="Unit">Suboden Khan</p>
<p id="title">Master of the War Council</p>

<!--Showcase of item image, name, and painting options to add to cart-->
<div class="product">
    <img src="../../finalProjectUnits/Suboden.jpg" alt="Suboden Khan">
