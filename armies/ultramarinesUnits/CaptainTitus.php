...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='9'";
...
<!--Unit name and title-->
<p id="Unit">Captain Titus</p>
<p id="title">The Warden of Ultramar</p>

	<!--Unit image, price and cart options-->
<div class="product">
    <img src="../../finalProjectUnits/Titus.jpg" alt="Captain Titus">
