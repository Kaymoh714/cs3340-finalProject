...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='11'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Varro Tigurius unit">
...
<p id="Unit">Varro Tigurius</p>
<p id="title">Master of Arcana</p>

<!--Unit image, price and cart options-->	
<div class="product">
    <img src="../../finalProjectUnits/Tigurius.jpg" alt="Varro Tigurius">
