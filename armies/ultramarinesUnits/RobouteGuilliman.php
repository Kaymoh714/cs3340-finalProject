...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='10'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Roboute Guilliman unit">
...
<!--Unit name and title-->	
<p id="Unit">Roboute Guilliman</p>
<p id="title">Primarch of the Ultramarines</p>

<!--Unit image, price and paint options-->
<div class="product">
    <img src="../../finalProjectUnits/Guilliman.jpg" alt="Roboute Guilliman">
