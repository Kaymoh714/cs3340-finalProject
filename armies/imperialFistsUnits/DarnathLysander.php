...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='15'";
...
<html lang="en">
	<head>
		...
		<meta name="description" content = "Darnath Lysander unit">
...
<!--Unit name and title-->	
<p id="Unit">Darnath Lysander</p>
<p id="title">Watch Commander of the Phalanx</p>

<!--Product select form-->	
<div class="product">
    <img src="../../finalProjectUnits/Darnath.jpg" alt="Darnath Lysander">
