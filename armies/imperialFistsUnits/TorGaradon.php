...
$sql = "SELECT basicPrice, advancedPrice, quantity FROM products WHERE productID='14'";
...
<!--Unit name and title-->	
<p id="Unit">Tor Garadon</p>
<p id="title">The Bastion of Defiance</p>

<!--Product select form-->	
<div class="product">
    <img src="../../finalProjectUnits/Garadon.jpg" alt="Tor Garadon">
